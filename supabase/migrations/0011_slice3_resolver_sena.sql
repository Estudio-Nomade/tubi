...
values (
  ...
  'aaaaaaaa-bbbb-cccc-dddd-000000000099',
  jsonb_build_object(
    'sub', 'aaaaaaaa-bbbb-cccc-dddd-000000000099',
    'email', 'operador.demo@tubi.local',
    'email_verified', true
  ),
  'email',
  'aaaaaaaa-bbbb-cccc-dddd-000000000099',
...
-- profiles_insert_own blocks operador self-signup; seed as postgres bypasses RLS
...
set rol = 'operador', nombre = excluded.nombre, apellido = excluded.apellido;
